...
interfaces.
- [util](/test/util) which tests the utilities (whive-util, whive-tx, ...).
...
Before tests can be run locally, Whive Core must be built.  See the [building instructions](/doc#building) for help.
