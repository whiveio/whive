...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 WHIVE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 WHIVE with subtract fee from amount
        ...
        # Sendmany 10 WHIVE with subtract fee from amount
