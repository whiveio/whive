...
This guide describes how to build whived, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run whived or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](git clone https://github.com/whiveio/whive/blob/master/doc/descriptors.md).
...
There are many ways to configure Whive Core. Here is an example that
