# Fuzzing Whive Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Whive Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
## Overview of Whive Core fuzzing

[Google](https://github.com/google/fuzzing/) has a good overview of fuzzing in general, with contributions from key architects of some of the most-used fuzzers. [This paper](https://agroce.github.io/bitcoin_report.pdf) includes an external overview of the status of Whive Core fuzzing, as of summer 2021.  [John Regehr](https://blog.regehr.org/archives/1687) provides good advice on writing code that assists fuzzers in finding bugs, which is useful for developers to keep in mind.
...
Every single pull request submitted against the Whive Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Whive Core more robust.
...
# Fuzzing Whive Core using afl++

## Quickstart guide

To quickly get started fuzzing Whive Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Whive Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Whive Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the Whive Core P2P layer using Honggfuzz NetDriver

Honggfuzz NetDriver allows for very easy fuzzing of TCP servers such as Whive
...
# Fuzzing Whive Core using Eclipser (v1.x)

## Quickstart guide

To quickly get started fuzzing Whive Core using [Eclipser v1.x](https://github.com/SoftSec-KAIST/Eclipser/tree/v1.x):
...
Whive Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitcoin-core)
...
because Whive is a live P2P network, and not just standalone local software,
