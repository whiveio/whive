...
with certain assembly code from Whive Core's code. See [developer notes on sanitizers](https://github.com/bitcoin/bitcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Whive Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Whive Core using [`afl-fuzz`](https://github.com/google/afl):
