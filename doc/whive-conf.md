...
Changes to the configuration file while `whived` or `whive-qt` is running only take effect after restarting.
...
-- | -- | --
Windows | `%LOCALAPPDATA%\Whive\` | `C:\Users\username\AppData\Local\Whive\whive.conf`
...
An example configuration file can be generated by [contrib/devtools/gen-whive-conf.sh](../contrib/devtools/gen-whive-conf.sh).
Run this script after compiling to generate an up-to-date configuration file.
The output is placed under `share/examples/whive.conf`.
To use the generated configuration file, copy the example file into your data directory and edit it there, like so:

```
# example copy command for linux user
cp share/examples/whive.conf ~/.whive
```
