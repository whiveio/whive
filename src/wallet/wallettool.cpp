...
// queue, which doesn't exist for the whive-wallet. Define our own
// deleter here.
...
bool ExecuteWalletToolFunc(const ArgsManager& args, const std::string& command)
{
    ...
    if (command == "create") {
        ...
        tfm::format(std::cout, "The dumpfile may contain private keys. To ensure the safety of your Whive, do not share the dumpfile.\n");
        return ret;
