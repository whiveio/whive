...
pkgdatadir = $(datadir)/whiveyes
pkgincludedir = $(includedir)/whiveyes
pkglibdir = $(libdir)/whiveyes
pkglibexecdir = $(libexecdir)/whiveyes
...
CONFIG_CLEAN_FILES = libwhiveyesconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libwhiveyesconsensus.pc.in \
...
ACLOCAL = ${SHELL} /home/qwainaina/whiveyes/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/qwainaina/whiveyes/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/qwainaina/whiveyes/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/qwainaina/whiveyes/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = whiveyes-cli
BITCOIN_DAEMON_NAME = whiveyesd
BITCOIN_GUI_NAME = whiveyes-qt
BITCOIN_TX_NAME = whiveyes-tx
...
COPYRIGHT_HOLDERS_FINAL = The Whiveyes Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Whiveyes Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/qwainaina/whiveyes/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = whiveyes
PACKAGE_BUGREPORT = https://github.com/whiveyes/whiveyes/issues
PACKAGE_NAME = Whiveyes Core
PACKAGE_STRING = Whiveyes Core 2.0.0
PACKAGE_TARNAME = whiveyes
PACKAGE_URL = https://whiveyes.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/qwainaina/whiveyes
abs_srcdir = /home/qwainaina/whiveyes
abs_top_builddir = /home/qwainaina/whiveyes
abs_top_srcdir = /home/qwainaina/whiveyes
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/qwainaina/whiveyes/build-aux/install-sh
...
pkgconfig_DATA = libwhiveyesconsensus.pc
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/whiveyes.icns
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/whiveyes.ico \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/whiveyes.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Whiveyes-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
libwhiveyesconsensus.pc: $(top_builddir)/config.status $(srcdir)/libwhiveyesconsensus.pc.in
...
$(OSX_APP)/Contents/Resources/whiveyes.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/Whiveyes-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Whiveyes-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Whiveyes-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
